...
**Valeur utilisateur :** refonte du drawer de droite livré en jalon 12 pour le rendre plus lisible et exploitable.
...
- 14.1 peut être fait en premier et en parallèle des autres. Le Tooltip devient prérequis doux pour 14.3 (mention source/cible).
